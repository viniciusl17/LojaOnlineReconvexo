...
function abrirCarrinho() {
  ...
  export function adicionarAoCarrinho(idProduto) {
    ...
    <button id="" class="absolute top-0 right-2">
      <i class="fa-solid fa-circle-xmark text-orange-500 hover:text-orange-800"></i>
    </button>

    <img src="./assets/${produto.imagem}" alt=" Carrinho: ${produto.nome}" class="h-24 rounded-lg">
    <div class="py-2">
